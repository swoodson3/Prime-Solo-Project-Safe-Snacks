...
router.put('/:id', (req, res) => {
  ...
  pool.query(sqlText, values)
    .then((result) => {
      const values = [dogToUpdate.description, dogToUpdate.favorite, dogToUpdate.notes, dogId]
      const sqlText = `INSERT INTO "food" ("description", "favorite", "notes", "dog_id") VALUES ($1, $2, $3, $4);`
      pool.query(sqlText, values)
        .then((result) => {
        })
        .catch((error) => {
